...
type reloc_info =
    Reloc_literal of Obj.t        (* translated structured constant *)
  | Reloc_getpredef of string     (* reference to a predefined value *)
  | Reloc_getglobal of globalname (* reference to a global *)
  | Reloc_setglobal of globalname (* definition of a global *)
...
type compilation_unit =
  { cu_name: modname;                   (* Name of compilation unit *)
    ...
    cu_required_globals: globalname list;  (* Compilation units whose
