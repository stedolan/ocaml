...
val newvar: ?name:string -> ?layout:Types.layout -> unit -> type_expr
val newvar2: ?name:string -> layout:Types.layout -> int -> type_expr
...
val instance_poly:
        ...
        (type_expr * layout) list * type_expr
        (* Take an instance of a type scheme containing free univars *)
val polyfy: Env.t -> type_expr -> (type_expr * layout) list -> type_expr * bool
val instance_label:
        bool -> label_description ->
        (type_expr * layout) list * type_expr * type_expr
        (* Same, for a label *)
val apply:
