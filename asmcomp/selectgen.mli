...
class virtual selector_generic : object
  ...
  method regs_for : Cmm.machtype -> Reg.t array
    (* Return an array of fresh registers of the given type.
       ...
       integer registers. *)
  method insert_op :
    Mach.operation -> Mach.operand array -> Reg.t array -> Reg.t array
    (* Can be overridden to deal with 2-address instructions
       or instructions with hardwired input/output registers *)
  method insert_op_debug :
    Mach.operation -> Debuginfo.t -> Mach.operand array -> Reg.t array -> Reg.t array
    (* Can be overridden to deal with 2-address instructions
       or instructions with hardwired input/output registers *)
  method emit_extcall_args :
    environment -> Cmm.expression list -> Mach.operand array * int
    (* Can be overridden to deal with stack-based calling conventions *)
  method emit_stores :
    environment -> Cmm.expression list -> Reg.t -> unit
  ...
  method insert : Mach.instruction_desc -> Mach.operand array -> Reg.t array -> unit
  ...
  method insert_operand_moves : Mach.operand array -> Mach.operand array -> unit
  method emit_expr :
