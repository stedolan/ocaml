...
let bindir = {|/home/sdolan/q/dynlink/_install/bin|}

let standard_library_default = {|/home/sdolan/q/dynlink/_install/lib/ocaml|}
...
let ocamlc_cflags = {| -O2 -fno-strict-aliasing -fwrapv -pthread -fPIC  -pthread|}
...
let ocamlopt_cflags = {| -O2 -fno-strict-aliasing -fwrapv -pthread -fPIC  -pthread|}
let ocamlopt_cppflags = {| -D_FILE_OFFSET_BITS=64 |}
let bytecomp_c_libraries = {| -lzstd  -lm -ldl  -lpthread|}
...
let native_c_libraries = {| -lzstd  -lm -ldl  -lpthread|}
let native_ldflags = {||}
...
let mkexe = {|gcc -O2 -fno-strict-aliasing -fwrapv -pthread  -pthread  -Wl,-E |}
